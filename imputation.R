...
###############################################################################
#' The available imputation methods.
#'
#' @returns A character vector of available imputation methods.
...
#' The available imputation methods for missing-at-random (MAR) values.
#'
#' @returns A character vector of available imputation methods.
...
#' The available imputation methods for missing-not-at-random (MNAR) values.
#'
#' @returns A character vector of available imputation methods.
...
#' The available imputation mixed methods.
#'
#' @returns A character vector of available imputation methods.
...
imputation <- function(
  ...
  data_imputed <- bind_cols(
    df_wide %>% select(!where(is.numeric)),
    as_tibble(mx_imput)
  ) %>% 
    pivot_longer(cols = all_of(cols), names_to = 'label', values_to = 'LFQ')
